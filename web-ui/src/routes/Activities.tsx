          ...
          return (
            <li key={activity.id}>
              <button
                ...
                className="flex w-full items-center gap-3 rounded-lg bg-card px-4 py-3 text-left transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                <SportIcon
